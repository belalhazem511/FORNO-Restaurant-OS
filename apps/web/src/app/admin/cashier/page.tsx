...
import { Card, CardHeader, CardTitle, CardDescription, CardContent } from "@forno/ui/components/card";
import { TableRow, TableCell } from "@forno/ui/components/table";
...
import { DataTable, TableActions, type Column } from "@forno/ui/components/data-table";
import { DropdownMenu, DropdownMenuTrigger, DropdownMenuContent, DropdownMenuItem } from "@forno/ui/components/dropdown-menu";
            ...
            <DataTable
              ...
              afterRows={
                <TableRow className="bg-muted/50">
                  ...
                  <TableCell><div className="relative"><span className="absolute start-2 top-1/2 -translate-y-1/2 text-muted-foreground text-xs">ج.م</span><Input type="number" min="0.01" step="0.01" value={inlineForm.amount || ""} onChange={(e) => setInlineForm({ ...inlineForm, amount: Number(e.target.value) })} placeholder="0.00" className="h-8 ps-10" /></div></TableCell>
